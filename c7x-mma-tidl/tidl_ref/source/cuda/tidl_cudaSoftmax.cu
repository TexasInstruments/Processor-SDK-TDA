...
{
    size_t input_size = sizeof(float)*(1+ (inDims[5]-1) * inPitches[5] + (inDims[4]-1) * inPitches[4] + (inDims[3]-1) * inPitches[3] + (inDims[2]-1) * inPitches[2] + (inDims[1]-1) * inPitches[1] + (inDims[0]-1) * inPitches[0]);
    size_t output_size = sizeof(float)*(1+ (inDims[5]-1) * outPitches[5] + (inDims[4]-1) * outPitches[4] + (inDims[3]-1) * outPitches[3] + (inDims[2]-1) * outPitches[2] + (inDims[1]-1) * outPitches[1] + (inDims[0]-1) * outPitches[0]);
