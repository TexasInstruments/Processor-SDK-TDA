...
)
{
    ...
    if (inBPtr != NULL) {
        ...
        if (inputBTranspose != 0) {
            ...
            for (uint32_t inColIdx = 0; inColIdx < numInCols; inColIdx++) {
                sum += (Tacc)inPtr[inOffset + inColIdx] * (Tacc)inBPtr[biasOffset + inColIdx];
            }
        } else {
            // No transpose needed
            inOffset = inOffset + (inALinePitch * outRwIdx);
            ...
            for (uint32_t inColIdx = 0; inColIdx < numInCols; inColIdx++) {
                sum += (Tacc)inPtr[inOffset + inColIdx] * (Tacc)inBPtr[biasOffset + (inColIdx * inBLinePitch)];
            }
        }
    } else {
        // Use static weights
        if (inputBTranspose != 0) {
            ...
            biasOffset = biasOffset + (outColIdx * inBLinePitch);
            for (uint32_t inColIdx = 0; inColIdx < numInCols; inColIdx++) {
                sum += (Tacc)inPtr[inOffset + inColIdx] * (Tacc)weightsPtr[biasOffset + inColIdx];
            }
        } else {
            // No transpose needed
            inOffset = inOffset + (inALinePitch * outRwIdx);
            biasOffset = biasOffset + outColIdx;
            for (uint32_t inColIdx = 0; inColIdx < numInCols; inColIdx++) {
                sum += (Tacc)inPtr[inOffset + inColIdx] * (Tacc)weightsPtr[biasOffset + (inColIdx * inBLinePitch)];
            }
        }
    }
    ...
    {
        bfloat16_tidl result = cuda_bf16Sat(sum, floatSatLow, floatSatHigh);
...
template int TIDL_cudaInnerProductFused<bfloat16_tidl, bfloat16_tidl, bfloat16_tidl, float, bfloat16_tidl, float>(bfloat16_tidl const*, bfloat16_tidl const*, bfloat16_tidl*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<bfloat16_tidl, bfloat16_tidl, short, float, bfloat16_tidl, float>(bfloat16_tidl const*, bfloat16_tidl const*, bfloat16_tidl*, float const*, short const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<bfloat16_tidl, bfloat16_tidl, signed char, float, bfloat16_tidl, float>(bfloat16_tidl const*, bfloat16_tidl const*, bfloat16_tidl*, float const*, signed char const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<unsigned short, unsigned short, bfloat16_tidl, float, bfloat16_tidl, float>(unsigned short const*, unsigned short const*, bfloat16_tidl*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<unsigned short, short, bfloat16_tidl, float, bfloat16_tidl, float>(unsigned short const*, short const*, bfloat16_tidl*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<short, short, bfloat16_tidl, float, bfloat16_tidl, float>(short const*, short const*, bfloat16_tidl*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<short, unsigned short, bfloat16_tidl, float, bfloat16_tidl, float>(short const*, unsigned short const*, bfloat16_tidl*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<unsigned char, unsigned char, bfloat16_tidl, float, bfloat16_tidl, float>(unsigned char const*, unsigned char const*, bfloat16_tidl*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<unsigned char, signed char, bfloat16_tidl, float, bfloat16_tidl, float>(unsigned char const*, signed char const*, bfloat16_tidl*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<signed char, unsigned char, bfloat16_tidl, float, bfloat16_tidl, float>(signed char const*, unsigned char const*, bfloat16_tidl*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<signed char, signed char, bfloat16_tidl, float, bfloat16_tidl, float>(signed char const*, signed char const*, bfloat16_tidl*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<signed char, signed char, bfloat16_tidl, float, signed char, float>(signed char const*, signed char const*, signed char*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<signed char, unsigned char, bfloat16_tidl, float, signed char, float>(signed char const*, unsigned char const*, signed char*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<unsigned char, signed char, bfloat16_tidl, float, signed char, float>(unsigned char const*, signed char const*, signed char*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<unsigned char, unsigned char, bfloat16_tidl, float, signed char, float>(unsigned char const*, unsigned char const*, signed char*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<short, short, bfloat16_tidl, float, short, float>(short const*, short const*, short*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<short, unsigned short, bfloat16_tidl, float, short, float>(short const*, unsigned short const*, short*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<unsigned short, short, bfloat16_tidl, float, short, float>(unsigned short const*, short const*, short*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<unsigned short, unsigned short, bfloat16_tidl, float, short, float>(unsigned short const*, unsigned short const*, short*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<signed char, signed char, bfloat16_tidl, float, unsigned char, float>(signed char const*, signed char const*, unsigned char*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<signed char, unsigned char, bfloat16_tidl, float, unsigned char, float>(signed char const*, unsigned char const*, unsigned char*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<unsigned char, signed char, bfloat16_tidl, float, unsigned char, float>(unsigned char const*, signed char const*, unsigned char*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<unsigned char, unsigned char, bfloat16_tidl, float, unsigned char, float>(unsigned char const*, unsigned char const*, unsigned char*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<short, short, bfloat16_tidl, float, unsigned char, float>(short const*, short const*, unsigned char*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<short, unsigned short, bfloat16_tidl, float, unsigned char, float>(short const*, unsigned short const*, unsigned char*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<unsigned short, short, bfloat16_tidl, float, unsigned char, float>(unsigned short const*, short const*, unsigned char*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<unsigned short, unsigned short, bfloat16_tidl, float, unsigned char, float>(unsigned short const*, unsigned short const*, unsigned char*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<short, short, bfloat16_tidl, float, unsigned short, float>(short const*, short const*, unsigned short*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<unsigned short, short, bfloat16_tidl, float, unsigned short, float>(unsigned short const*, short const*, unsigned short*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<unsigned short, unsigned short, bfloat16_tidl, float, unsigned short, float>(unsigned short const*, unsigned short const*, unsigned short*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<bfloat16_tidl, bfloat16_tidl, signed char, int, bfloat16_tidl, long>(bfloat16_tidl const*, bfloat16_tidl const*, bfloat16_tidl*, int const*, signed char const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<bfloat16_tidl, bfloat16_tidl, signed char, short, bfloat16_tidl, long>(bfloat16_tidl const*, bfloat16_tidl const*, bfloat16_tidl*, short const*, signed char const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<bfloat16_tidl, bfloat16_tidl, short, long, bfloat16_tidl, long>(bfloat16_tidl const*, bfloat16_tidl const*, bfloat16_tidl*, long const*, short const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<bfloat16_tidl, bfloat16_tidl, short, int, bfloat16_tidl, long>(bfloat16_tidl const*, bfloat16_tidl const*, bfloat16_tidl*, int const*, short const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<float, float, bfloat16_tidl, float, float, float>(float const*, float const*, float*, float const*, bfloat16_tidl const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
template int TIDL_cudaInnerProductFused<bfloat16_tidl, bfloat16_tidl, float, float, bfloat16_tidl, float>(bfloat16_tidl const*, bfloat16_tidl const*, bfloat16_tidl*, float const*, float const*, int, int, int, int, int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, int, int, int, int, int, int, float, float, int, int, int, int, unsigned char const*, unsigned char const*);
