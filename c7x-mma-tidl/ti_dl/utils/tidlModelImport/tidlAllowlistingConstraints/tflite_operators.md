...
| 5 | FullyConnected | TIDL_InnerProductLayer | <ul> <li> Number of non-singleton variable input dimensions must be <= 4 </li><li> Filter tensor input should have atleast 2 dimensions </li><li> Filter and input must be of same dimensions or broadcast-able </li></ul> | 
...
| 8 | Concatenation | TIDL_ConcatLayer | <ul> <li> Number of non-singleton variable input dimensions must be <= 6 </li><li> Only supported across width, height and channel axis </li><li> Not supported along the batch dimension </li></ul> | 
...
| 21 | LeakyRelu | TIDL_LeakyReluLayer | <ul> <li> Number of non-singleton variable input dimensions must be <= 6 </li></ul> | 
