...
SECTIONS
{
    ...
    .text               : {} palign(8)      > DDR_RMCU1_1
    .const              : {} palign(8)      > DDR_RMCU1_1
    .rodata             : {} palign(8)      > DDR_RMCU1_1
    .cinit              : {} palign(8)      > DDR_RMCU1_1
    .bss                : {} align(8), RUN_START(__BSS_START), RUN_END(__BSS_END) > DDR_RMCU1_1
    .far                : {} align(4)       > DDR_RMCU1_1
    .data               : {} palign(128)    > DDR_RMCU1_1
    .sysmem             : { . = . + __HEAP_SIZE;  } > DDR_RMCU1_1
    .data_buffer        : {} palign(128)    > DDR_RMCU1_1
    .boardcfg_data      : {} align(4)       > DDR_RMCU1_1
    .bss:taskStackSection            : {}   > DDR_RMCU1_1

    .resource_table          :
    {
        __RESOURCE_TABLE = .;
    }                                           > DDR_RMCU1_1_RESOURCE_TABLE

    .tracebuf                : {} align(1024)   > DDR_RMCU1_1

    .stack                   : {} align(4)      > DDR_RMCU1_1  (HIGH)

    .bss:ddr_local_mem      (NOLOAD) : {} > DDR_RMCU1_1_LOCAL_HEAP
    ...
    .bss.debug_mem_trace_buf    : {} palign(128)    > DDR_RMCU1_1_IPC_TRACE
