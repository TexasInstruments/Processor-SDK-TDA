...
/* LDRA_JUSTIFY_END */
            ...
            if (vxGetStatus(vxCastRefFromImage(image)) == (vx_status)VX_SUCCESS)
            {
                ...
                tivx_obj_desc_memcpy(&uni_img_obj_desc->uniform_image_pixel_value, value, (uint32_t)sizeof(vx_pixel_value_t));
            }
        }
    }
    return image;
...
/* LDRA_JUSTIFY_START
<metric start> statement branch <metric end>
<justification start> TIOVX_BRANCH_COVERAGE_TIVX_IMAGE_UBR033
<justification end>*/
    {
/* LDRA_JUSTIFY_END */
...
/* LDRA_JUSTIFY_START
<metric start> branch <metric end>
<justification start> TIOVX_BRANCH_COVERAGE_TIVX_IMAGE_UBR034
<justification end> */
                    if ((vx_status)VX_SUCCESS == status)
/* LDRA_JUSTIFY_END */
                    {
...
/* LDRA_JUSTIFY_START
<metric start> branch <metric end>
<justification start> TIOVX_BRANCH_COVERAGE_TIVX_IMAGE_UBR035
<justification end> */
                        if (status == (vx_status)VX_SUCCESS)
/* LDRA_JUSTIFY_END */
                        {
...
/* LDRA_JUSTIFY_START
<metric start> branch <metric end>
<justification start> TIOVX_BRANCH_COVERAGE_TIVX_IMAGE_UBR036
<justification end> */
        if (tensor != NULL)
/* LDRA_JUSTIFY_END */
        {
...
/* LDRA_JUSTIFY_START
<metric start> branch <metric end>
<justification start> TIOVX_BRANCH_COVERAGE_TIVX_IMAGE_UBR037
<justification end> */
...
/* LDRA_JUSTIFY_START
<metric start> statement branch <metric end>
<justification start> TIOVX_BRANCH_COVERAGE_TIVX_IMAGE_UBR038
<justification end> */
                if (status != (vx_status)VX_SUCCESS)
                {
