...
\cond SOC_J722S
   ...
   -# \subpage EXAMPLES_DRIVERS_SBL_EMMC
   -# \subpage EXAMPLES_DRIVERS_SBL_OSPI
   -# \subpage EXAMPLES_DRIVERS_SBL_OSPI_EARLY_CAN
   -# \subpage EXAMPLES_DRIVERS_SBL_OSPI_NAND
   -# \subpage EXAMPLES_DRIVERS_SBL_UART_UNIFLASH
   -# \subpage EXAMPLES_DRIVERS_SBL_OSPI_HLOS
   -# \subpage EXAMPLES_DRIVERS_SBL_SD_HLOS
   -# \subpage EXAMPLES_DRIVERS_SBL_EMMC_HLOS
   -# \subpage EXAMPLES_DRIVERS_SBL_OSPI_NAND_HLOS
   -# \subpage EXAMPLES_DRIVERS_SBL_NON_BOOTED_CORE_TEST
\endcond
