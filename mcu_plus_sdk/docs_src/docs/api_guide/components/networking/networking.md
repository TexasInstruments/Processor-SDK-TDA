...
\cond SOC_AM62PX || SOC_AM62DX || SOC_AM62X || SOC_AM275X || SOC_AM62LX || SOC_J722S
...
\cond SOC_J722S
- Common Port SWitch (**CPSW**) : CPSW subsystem provides IEEE 802.3 standard Ethernet gigabit speed packet communication for the device and can also be configured as an Ethernet switch. CPSW supports RGMII,RMII,SGMII Interfaces.
\endcond
