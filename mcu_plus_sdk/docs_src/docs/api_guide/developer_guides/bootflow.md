...
\cond SOC_J722S
  ...
  - \ref EXAMPLES_DRIVERS_SBL_OSPI
  - \ref EXAMPLES_DRIVERS_SBL_OSPI_NAND
  - \ref EXAMPLES_DRIVERS_SBL_UART
  - \ref EXAMPLES_DRIVERS_SBL_OSPI_HLOS
  - \ref EXAMPLES_DRIVERS_SBL_SD_HLOS
  - \ref EXAMPLES_DRIVERS_SBL_EMMC_HLOS
  - \ref EXAMPLES_DRIVERS_SBL_OSPI_NAND_HLOS
\endcond
\cond SOC_AM64X
