...
MEMORY
{
    ...
    MSRAM     : ORIGIN = 0x72080000 , LENGTH = 0x50000

    TSK_MSRAM0                 : ORIGIN = 0x720d0000 LENGTH = 0x4000
    TSK_MSRAM1                 : ORIGIN = 0x720d4000 LENGTH = 0x4000
    TSK_MSRAM2                 : origin = 0x720d8000 LENGTH = 0x4000
    TSK_MSRAM3                 : origin = 0x720dC000 LENGTH = 0x4000
    TSK_MSRAM4                 : origin = 0x720e0000 LENGTH = 0x4000
    TSK_MSRAM5                 : origin = 0x720e4000 LENGTH = 0x4000
    TSK_MSRAM6                 : origin = 0x720e8000 LENGTH = 0x4000
    TSK_MSRAM7                 : origin = 0x720eC000 LENGTH = 0x4000
    TSK_MSRAM8                 : origin = 0x720f0000 LENGTH = 0x4000
    TSK_MSRAM9                 : origin = 0x720f4000 LENGTH = 0x4000
