...
let dss_module = {
    ...
    templates: {
        "/drivers/system/system_config.c.xdt": {
            driver_config: "/drivers/dss/templates/v1/dss_config.c.xdt",
        },
        "/drivers/system/system_config.h.xdt": {
            driver_config: "/drivers/dss/templates/v1/dss.h.xdt",
        },
        "/drivers/system/drivers_open_close.h.xdt": {
            driver_open_close_config: "/drivers/dss/templates/v1/dss_open_close.h.xdt",
        },
...
function validate(inst, report) {
    ...
    if (inst.$name == "CONFIG_DSS1" && (inst.selectVP != "VP4" || inst.selectOverlayManager != "OVR4" || inst.selectDisplayInterface != "DSI") )
    {
        report.logError("Use, OVR4 and VP4 with DSI output interface!", inst, "selectVP");
    }
